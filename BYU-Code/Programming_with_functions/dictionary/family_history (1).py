...
def main():
    ...
    dead_age = print_death_age(people_dict)
    ...
    marriage_age = print_marriages(marriages_dict, people_dict)
...
def print_death_age(people_dict):
    ...
    for item in people_dict.items():
        ...
        dead_age = value[DEATH_YEAR_INDEX] - value[BIRTH_YEAR_INDEX]

        print(f"{name}, {dead_age}")
...
#        value = item[1]
#
#        count_male = value[GENDER_INDEX == "M"]
#
#    return coun_male
#
#
...
#Return: nothing
#"""
    for item in print_marriages.items():
        key1 = item[0]
        value = item[1]
        name = value[NAME_INDEX]
